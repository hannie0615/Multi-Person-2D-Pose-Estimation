...
class OpenPose_Feature(nn.Module):
    def __init__(self):
        ...
        # VGG-19의 최초 10개 신경망 사용
        vgg19 = torchvision.models.vgg19(pretrained=True)
        model = {}
        model['block0'] = vgg19.features[0:23]  # 10개의 신경망은 23개의 레이어까지임.
...
# 모델 서머리 출력
#import torchsummary
#model = OpenPoseNet().cuda()
#print(torchsummary.summary(model, (3,368,368), batch_size=32))
